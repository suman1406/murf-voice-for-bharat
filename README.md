...
- **Target Use-Case:** Delivering real-time crop advisory, market prices (mandi rates), weather updates, and agricultural schemes to farmers in India via natural voice interaction.
...
See [`day1/README.md`](./day1/README.md) for full setup and execution instructions.
